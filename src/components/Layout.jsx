        ...
        <div className="mx-auto flex max-w-4xl items-center justify-between gap-3 px-4 py-3">
          ...
          <div className="flex items-center gap-2 text-sm">
            ...
            <button
              ...
              className="min-h-[36px] rounded-md px-2 text-slate-500 transition-colors hover:text-slate-900 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-teal-300 dark:text-slate-400 dark:hover:text-slate-100"
            >
              Wyloguj
            </button>
          </div>
