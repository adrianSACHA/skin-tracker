...
export default function PhotoUploadForm({ lesion, personId, onUploaded, onCancel }) {
    ...
    >
      ...
      <div className="space-y-2">
        ...
        <input
          ...
          capture="environment"
          onChange={handleFile}
          className="block w-full text-sm text-slate-600 file:mr-3 file:min-h-[44px] file:rounded-lg file:border-0 file:bg-teal-700 file:px-4 file:font-medium file:text-white hover:file:bg-teal-800"
        />
        {previewUrl ? (
          <img
            src={previewUrl}
        ...
        <p className="text-xs text-slate-400">
          Zdjęcie zostanie automatycznie skompresowane (max ~0.4 MB, webp, orientacja EXIF).
        </p>
      </div>
      ...
      <label className="flex items-start gap-2 text-sm text-slate-700">
        <input
          ...
          className="mt-0.5 h-5 w-5 rounded border-slate-300 text-teal-700 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-teal-300"
        />
        <span>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div>
          ...
          <input
            ...
            className="min-h-[44px] w-full rounded-lg border border-slate-300 px-3 py-2 text-slate-900 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-teal-300"
          />
        </div>
        <div>
          <label
      ...
      <fieldset className="space-y-3 rounded-lg bg-slate-50 p-3">
        ...
        <label className="flex items-center gap-2 text-sm text-slate-700">
          <input
            ...
            className="h-5 w-5 rounded border-slate-300 text-teal-700 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-teal-300"
          />
          Asymetria (A)
        </label>
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full rounded-lg border border-slate-300 px-3 py-2 text-slate-900 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-teal-300"
          />
        </div>
      </fieldset>
